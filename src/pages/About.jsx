    ...
    return (
        <>
            ...
            <div className="container">
                <h1 style={{ fontWeight: 'bold',margin:'200px 0 50px 0' }} className='text-center'>STATISTICS</h1>
                <div className="row mt-2">
                    <div className="main1 col-md-6 col-sm-12">
                        <p>Total Students Eligible (vs) Total Number Of Job Offers</p>
                        <CChart
                            type="line"
                            data={{
                    ...
                    <div className="main2 col-md-6 col-sm-12">
